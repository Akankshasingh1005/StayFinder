...
import { addListing, deleteListing, findListing, getFilteredListings, getListing, updateListing } from "../controllers/listing.controller.js"
...
listingRouter.get("/", getFilteredListings);
